...
import com.IntegradorFinal.persistence.entities.Odontologo;
import com.IntegradorFinal.persistence.repository.OdontologoRepository;
import com.IntegradorFinal.service.interfaces.OdontologoServiceInterface;
...
public class OdontologoService implements OdontologoServiceInterface {
    ...
    public String eliminar(Integer id) throws ResourceNotFoundException{
        ...
        if(repository.findById(id).isPresent()){
            ...
            respuesta = "Se ha eliminado el odontologo con el id: {}"+ id;
        } else {
